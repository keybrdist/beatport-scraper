...
exports.parseSearch = function (html, searchUrl) {
  ...
  var data = scrapeIt.scrapeHTML($, {
    list: {
      selector: 'div.bucket.labels ul',
      data: {
        name:  { selector: "li[data-ec-variant='label']", attr: 'data-ec-name' },
        id: { selector: "li[data-ec-variant='label']", attr: 'data-ec-id' },
        genres: { selector: "li[data-ec-variant='label']", attr: 'data-ec-d3' },
  ...
  var object = assignProps(data.list, {}, ['name', 'id', 'genres', 'imageUrl', 'url']);
